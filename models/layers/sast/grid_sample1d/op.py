...
# jit
# grid_sample1d = load(
#     'grid_sample1d_cuda', ['models/layers/maxvit/grid_sample1d/grid_sample1d_cuda.cpp', 'models/layers/maxvit/grid_sample1d/grid_sample1d_cuda_kernel.cu'], verbose=True)
